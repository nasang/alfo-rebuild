...
<div class="row justify-content-sm-center">
  ...
  <div class="col-sm-6 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/travel/tokyo/chidai_lukou.tiff" class="img-fluid rounded z-depth-1" zoomable=true %}
  </div>
</div>
...
<div class="row justify-content-sm-center">
  <div class="col-sm-8 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/travel/tokyo/chidai_zhaniupai_dian.tiff" class="img-fluid rounded z-depth-1" zoomable=true %}
  </div>
  <div class="col-sm-4 mt-3 mt-md-0">
...
<div class="row justify-content-sm-center">
  ...
  <div class="col-sm-4 mt-3 mt-md-0">
    ...
    <div class="col-sm-10 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/travel/tokyo/chidai_jiedao_2.tiff" class="img-fluid rounded z-depth-1" zoomable=true %}
  </div>
  <div class="col-sm-10 mt-3 mt-md-0">

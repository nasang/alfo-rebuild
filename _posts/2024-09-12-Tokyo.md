...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
      {% include video.liquid path="assets/video/travel/tokyo/xinsu_mao.mp4" class="img-fluid rounded z-depth-1" controls=true autoplay=true %}
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
...
<div class="row justify-content-sm-center">
  <div class="col-sm-12 mt-3 mt-md-0">
      {% include video.liquid path="assets/video/travel/tokyo/fuji.mp4" class="img-fluid rounded z-depth-1" controls=true autoplay=true %}
  </div>
  <div class="col-sm-4 mt-3 mt-md-0">
